...
class DeviceAuthorizationAction extends Action
{
    ...
    {
        try {
            // Try to respond to the device authorization request
            return $this->authorizationServer->respondToDeviceAuthorizationRequest($this->request, $this->response);
